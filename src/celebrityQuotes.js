...
let celebrityQuotes = {
  ...
  drPhilMcgraw: [
    `Its better to be healthy alone than sick with ${name()}.`,
    `You don't need a rope to pinch ${name()}'s butt.`,
    `You dont need a pack of ${name()}s to learn how to make a sandwich`,
    `Common sense needs to be more common.`,
    `Eighty percent of all of ${name()}'s questions are statements in disguise`,
    `Nothing is funnier to me than lauging at ${name()}.`,
  ],
